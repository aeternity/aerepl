...
| ~call_gas~ | ~true~ or ~false~ | Toggles display of used gas during evaluations. NOTE: This may not be 100% accurate. Treat it like a hint. |
...
Currently not supported. Balance related queries behave randomly.
